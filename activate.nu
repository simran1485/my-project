...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\codes\ML projects\Heart-Disease-Prediction-using-Machine-Learning-with-Python\test\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\codes\ML projects\Heart-Disease-Prediction-using-Machine-Learning-with-Python\test\venv\Scripts\deactivate.nu'
